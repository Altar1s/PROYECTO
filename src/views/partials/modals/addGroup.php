      ...
      <form class="form space-y-4">
         ...
         <div>
            ...
            <input value="<?php echo ($dataEntity["nombre"] ?? "") ?>" type="text" id="nombre" name="nombre" required
               class="w-full px-4 py-2 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:border-gray-800 transition-all text-sm text-gray-800 bg-white shadow-sm">
         </div>
         <div>
            ...
            <div class="relative">
               <select id="busqueda" name="profesor" required
                  class="w-full appearance-none px-4 py-2 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:border-gray-800 transition-all text-sm text-gray-800 bg-white shadow-sm pr-10">
