<div id="deleteModal" class="modal fixed inset-0 bg-gray-900/40 backdrop-blur-sm flex items-center justify-center z-50 transition-opacity duration-300">
   <div class="bg-white rounded-2xl shadow-2xl text-center max-w-sm w-full border border-gray-200 p-6 animate-fadeIn">
      ...
      <p class="text-slate-600 mb-6 text-sm">Esta acción eliminará la publicación de forma permanente. No se puede deshacer.</p>
      <div class="flex justify-center gap-3">
         <button data-type="delete" data-id="<?= $postId ?>" id="confirm-delete-post" class="bg-red-600 text-white px-5 py-2.5 rounded-full hover:bg-red-700 transition-all duration-300 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-red-300 hover:cursor-pointer">
            Eliminar
         </button>
